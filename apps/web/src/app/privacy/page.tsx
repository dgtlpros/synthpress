        ...
        <div className="mx-auto max-w-3xl">
          ...
          <div className="mt-12 space-y-12 text-base leading-relaxed text-muted">
            <section>
              ...
              <p>
                This Privacy Policy describes how SynthPress
                (&ldquo;SynthPress,&rdquo; &ldquo;we,&rdquo; &ldquo;us&rdquo;)
                collects, uses, and shares information when you use our website,
                products, and services (together, the &ldquo;Service&rdquo;). By
            ...
            <section>
              ...
              <ul className="mt-4 ml-6 list-disc space-y-2">
                <li>
                  ...
                  name, email address, and authentication identifiers when you
                  sign up.
                </li>
                <li>
                  <strong className="text-foreground">Connected sites:</strong>{" "}
                  URLs and credentials (encrypted at rest) for the WordPress
                  sites you connect to SynthPress.
                </li>
                <li>
                  <strong className="text-foreground">
                    Generated content:
                  </strong>{" "}
                  the prompts you submit and the articles, images, and metadata
                  produced on your behalf.
                </li>
                <li>
                  <strong className="text-foreground">Usage data:</strong> pages
                  viewed, features used, and generation logs to operate and
                  improve the Service.
                </li>
                <li>
                  <strong className="text-foreground">
                  ...
                  processed by our payment provider (Stripe). We do not store
            ...
            <section>
              ...
              <ul className="mt-4 ml-6 list-disc space-y-2">
                ...
                <li>
                  Process payments, manage subscriptions, and deliver receipts.
                </li>
                <li>
                  Communicate with you about product updates, security alerts,
            ...
            <section>
              ...
              <p>
                ...
                only with the following categories of recipients, and only as
                necessary:
              </p>
              <ul className="mt-4 ml-6 list-disc space-y-2">
                <li>
                  <strong className="text-foreground">Service providers</strong>{" "}
                  who help us operate the Service — including hosting (Vercel,
                  Supabase), payment processing (Stripe), and AI model providers
                ...
                <li>
                  ...
                  in which case we will notify you in advance.
                </li>
              </ul>
            </section>
            ...
            <section>
              ...
              <p>
                ...
                your account at any time, after which we will delete or
            ...
            <section>
              ...
              <p>
                ...
                remember your preferences, and measure product usage. You can
                disable cookies in your browser settings, but parts of the
            ...
            <section>
              ...
              <p>
                ...
                reviews — to protect your information. No method of transmission
                or storage is 100% secure, but we work hard to minimize risk.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                ...
                process your information in countries other than your own. We
                rely on appropriate safeguards (such as Standard Contractual
                Clauses) to protect personal information transferred
                internationally.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                ...
                Service before the changes take effect. The &ldquo;Last
